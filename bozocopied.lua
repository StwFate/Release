...
library.theme = {
    ...
    tabstextcolor = Color3.fromRGB(0, 150, 250),
    bordercolor = Color3.fromRGB(255, 255, 255),
    accentcolor = Color3.fromRGB(28, 56, 139),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(0, 150, 250),
    outlinecolor2 = Color3.fromRGB(0, 150, 250),
    sectorcolor = Color3.fromRGB(0, 150, 250),
    toptextcolor = Color3.fromRGB(0, 150, 250),
    topheight = 48,
    topcolor = Color3.fromRGB(0, 150, 250),
    topcolor2 = Color3.fromRGB(0, 150, 250),
    buttoncolor = Color3.fromRGB(255, 255, 255),
    buttoncolor2 = Color3.fromRGB(0, 150, 250),
    itemscolor = Color3.fromRGB(0, 150, 250),
    itemscolor2 = Color3.fromRGB(0, 150, 250),
}
